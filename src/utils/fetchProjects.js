...
import project5 from "../assets/projects/shoplobs.png";
...
export const projects = [
  {
    ...
    title: "Shoplobs",
    description:
      "A simple e-commerce frontend application that allows users to browse products and view ratings through a clean, responsive, and interactive interface.",
    image: project5,
    tech: ["Frontend", "React", "Tailwind"],
    github: "https://github.com/iamajlobo/shoplobs",
    live: "https://iamajlobo.github.io/shoplobs/",
  },
  {
    id: 4,
    title: "Lobodex",
    description:
      "A Pokédex-inspired web app that allows users to explore Pokémon data, including stats, and  types, with a responsive and interactive interface.",
    image: project4,
    tech: ["Frontend", "React", "Tailwind"],
